...
void Curiosity::ubicarElementos(){ 
    Quadtree arbol = Quadtree(1000,1000,1000,1000,0);
    for(auto it = this->elementos.begin();it!=this->elementos.end();it++){
        arbol.insert(*it);
    }
    cout<<"Elementos insertados en el arbol"<<endl;

    arbol.print();
}

void Curiosity::en_cuadrante(float a,float b,float c,float d){
    Quadtree arbol = Quadtree(a,b,c,d,0);
    for(auto it = this->elementos.begin();it!=this->elementos.end();it++){
        arbol.insert(*it);
    }
    cout<<"Elementos insertados en el arbol"<<endl;
