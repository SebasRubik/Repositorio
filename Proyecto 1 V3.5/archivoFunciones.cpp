...
sElemento cargarElemento(string linea, int &lineaActual){
    ...
    elemento.limites[0]= elemento.coorDx - elemento.tamanio/4;
    elemento.limites[1]= elemento.coorDx + elemento.tamanio/4;
    elemento.limites[2]= elemento.coorDy - elemento.tamanio/4;
    elemento.limites[3]= elemento.coorDy + elemento.tamanio/4;
    return elemento;
}
